...
public interface IDao<E extends IEntity, K extends Serializable> {
    ...
    <E extends IEntity> List getResultsByFieldName(Class<E> inEntityClass, String fieldName)
    ...
    <E extends IEntity, obj extends Object> List<E> getEntities(Class<E> inElementClass,
    ...
    <E extends IEntity, obj extends Object> List<E> getEntities(Class<E> inElementClass,
                                    StringBuffer query) throws DataAccessException;
