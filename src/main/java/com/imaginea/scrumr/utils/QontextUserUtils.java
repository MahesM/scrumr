...
public class QontextUserUtils {
	...
	public static String populateUsers(int startIndex, int count){
		try {
	...
	public static String searchUser(String sortType, boolean showTotalCount, int startIndex, int count){
		try {
