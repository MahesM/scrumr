...
public class GenericJpaDao<E extends IEntity, K extends Serializable> implements IDao<E, K> {
    ...
    public <E extends IEntity> List<Object> getResultsByFieldName(Class<E> inEntityClass,
                                    String fieldName) throws DataAccessException {
    ...
    public <E extends IEntity, obj> List<E> getEntities(Class<E> inElementClass, String queryName,
                                    Hashtable<String, obj> criteria) throws DataAccessException {
        Query qry = entityManager.createNamedQuery(queryName);
        Enumeration<String> keys = criteria.keys();
        while (keys.hasMoreElements()) {
    ...
    public <E extends IEntity, obj> List<E> getEntities(Class<E> inElementClass, String queryName,
                                    Hashtable<String, obj> criteria, Integer pageNumber,
    ...
    public <E extends IEntity, obj> List<E> getEntities(Class<E> inElementClass,
                                    StringBuffer query, Hashtable<String, obj> criteria) {
        Query qry = entityManager.createQuery(query.toString());
        Enumeration<String> keys = criteria.keys();
        while (keys.hasMoreElements()) {
            String key = keys.nextElement();
    ...
    public <E extends IEntity, obj> List<E> getEntities(Class<E> inElementClass, StringBuffer query)
                                    throws DataAccessException {
        Query qry = entityManager.createQuery(query.toString());
        Object result;
        try {
