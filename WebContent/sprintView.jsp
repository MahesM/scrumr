...
<script type="text/javascript" src="javascript/highcharts.js"></script>
	...
	<link type="text/css" rel="stylesheet" href="javascript/pagination.css" />
...
%>
  <script type='text/javascript'>
        $(function() {
			...
			//	addUserToStory(users_arr,storyId); //todo:need to integrate server change to accept user array and then uncomment properly
				$.ajax({
